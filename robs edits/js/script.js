...
d3.select("#share2").append("a")
	.attr("href",encodeURI("https://twitter.com/intent/tweet?text=I've been looking at my likelihood of being a victim of crime using official data. See for yourself at http://visual.ons.gov.uk/what-are-your-chances-of-experiencing-poverty-in-adulthood/"))
	.attr("target","_blank")
	.attr("class","share")
	.style("display","block")
	.style("height","25px")
